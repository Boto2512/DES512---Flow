...
using TMPro;
public class TestMovement : MonoBehaviour, IMomentumModifiable, IDamageable, ITargetable
{
    #region     ========================= Variables =========================
    ...
    private void MovePlayer()
    {
        ...
        if(isGrounded) { playerRigidBody.linearDamping = groundDrag;  } else { playerRigidBody.linearDamping = 0;}
    ...
    private void GroundCheck()
    {
        ...
        if (isGrounded) { Debug.Log("OnGROUND"); }
    }
    /// <summary>
